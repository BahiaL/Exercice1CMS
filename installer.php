...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221207_gamingsurprise_d23ceb7fa646a4496557_20221207125448_archive.zip';
        const ARCHIVE_SIZE       = '33389463';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'd23ceb7-07125448';
        const SECONDARY_PACKAGE_HASH = 'b0f1a4d-07125448';
        const VERSION            = '1.5.1';
